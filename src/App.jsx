...
const interpretLupusPRO = (score) => {
  ...
  if (score <= 75) return { text: 'CV moderada', color: '#f59e0b', level: 'moderate' };
  return { text: 'CV afectada', color: '#ef4444', level: 'poor' };
};
...
const interpretFACIT = (score) => {
  ...
  if (score >= 40) return { text: 'CV moderada', color: '#f59e0b', level: 'moderate' };
  return { text: 'CV afectada', color: '#ef4444', level: 'poor' };
};
...
const interpretSF36 = (score) => {
  ...
  if (score >= 50) return { text: 'Buena calidad de vida', color: '#84cc16', level: 'good' };
  if (score >= 25) return { text: 'CV moderada', color: '#f59e0b', level: 'moderate' };
  return { text: 'CV afectada', color: '#ef4444', level: 'poor' };
};
...
const interpretASQoL = (score) => {
  ...
  if (score <= 12) return { text: 'CV moderada', color: '#f59e0b', level: 'moderate' };
  return { text: 'CV afectada', color: '#ef4444', level: 'poor' };
};
...
const interpretPSAQoL = (score) => {
  ...
  if (score <= 14) return { text: 'CV moderada', color: '#f59e0b', level: 'moderate' };
  return { text: 'CV afectada', color: '#ef4444', level: 'poor' };
};
...
const LandingPage = ({ onNavigate }) => (
  <div className="landing-page">
    ...
    <div className="landing-content">
      ...
      <div className="landing-features"><div style={width:'100%',marginTop:'2rem',marginBottom:'1.5rem'}><div style={display:'flex',alignItems:'center',gap:'0.75rem',marginBottom:'1rem',paddingBottom:'0.5rem',borderBottom:'2px solid rgba(255,255,255,0.2)'}><span style={fontSize:'1.5rem'}>🦴</span><h3 style={margin:0,fontSize:'1.1rem',fontWeight:'600',color:'rgba(255,255,255,0.95)'}>Espondilo</h3></div><div style={{display:'flex',gap:'1rem',flexWrap:'wrap',justifyContent:'center'}}><div className="feature"><span className="feature-icon">📈</span><span>ASDAS</span></div><div className="feature"><span className="feature-icon">📊</span><span>BASDAI</span></div><div className="feature"><span className="feature-icon">🚶</span><span>BASFI</span></div><div className="feature"><span className="feature-icon">😊</span><span>ASQoL</span></div><div className="feature"><span className="feature-icon">💡</span><span>ASAS-HI</span></div></div></div><div style={width:'100%',marginTop:'2rem',marginBottom:'1.5rem'}><div style={display:'flex',alignItems:'center',gap:'0.75rem',marginBottom:'1rem',paddingBottom:'0.5rem',borderBottom:'2px solid rgba(255,255,255,0.2)'}><span style={fontSize:'1.5rem'}>🔴</span><h3 style={margin:0,fontSize:'1.1rem',fontWeight:'600',color:'rgba(255,255,255,0.95)'}>APs</h3></div><div style={{display:'flex',gap:'1rem',flexWrap:'wrap',justifyContent:'center'}}><div className="feature"><span className="feature-icon">📉</span><span>DAPSA</span></div><div className="feature"><span className="feature-icon">🎯</span><span>PsAQoL</span></div></div></div><div style={width:'100%',marginTop:'2rem',marginBottom:'1.5rem'}><div style={display:'flex',alignItems:'center',gap:'0.75rem',marginBottom:'1rem',paddingBottom:'0.5rem',borderBottom:'2px solid rgba(255,255,255,0.2)'}><span style={fontSize:'1.5rem'}>🔵</span><h3 style={margin:0,fontSize:'1.1rem',fontWeight:'600',color:'rgba(255,255,255,0.95)'}>AR</h3></div><div style={{display:'flex',gap:'1rem',flexWrap:'wrap',justifyContent:'center'}}><div className="feature"><span className="feature-icon">📋</span><span>DAS28</span></div></div></div><div style={width:'100%',marginTop:'2rem',marginBottom:'1.5rem'}><div style={display:'flex',alignItems:'center',gap:'0.75rem',marginBottom:'1rem',paddingBottom:'0.5rem',borderBottom:'2px solid rgba(255,255,255,0.2)'}><span style={fontSize:'1.5rem'}>🦋</span><h3 style={margin:0,fontSize:'1.1rem',fontWeight:'600',color:'rgba(255,255,255,0.95)'}>Lupus</h3></div><div style={{display:'flex',gap:'1rem',flexWrap:'wrap',justifyContent:'center'}}><div className="feature"><span className="feature-icon">🦋</span><span>SLEDAI</span></div><div className="feature"><span className="feature-icon">📋</span><span>SLICC</span></div></div></div><div style={width:'100%',marginTop:'2rem',marginBottom:'1.5rem'}><div style={display:'flex',alignItems:'center',gap:'0.75rem',marginBottom:'1rem',paddingBottom:'0.5rem',borderBottom:'2px solid rgba(255,255,255,0.2)'}><span style={fontSize:'1.5rem'}>💚</span><h3 style={margin:0,fontSize:'1.1rem',fontWeight:'600',color:'rgba(255,255,255,0.95)'}>CV</h3></div><div style={{display:'flex',gap:'1rem',flexWrap:'wrap',justifyContent:'center'}}><div className="feature"><span className="feature-icon">💪</span><span>FACIT</span></div><div className="feature"><span className="feature-icon">🏥</span><span>SF-36</span></div><div className="feature"><span className="feature-icon">💚</span><span>LupusPRO</span></div></div></div><div style={width:'100%',marginTop:'2rem',marginBottom:'1.5rem'}><div style={display:'flex',alignItems:'center',gap:'0.75rem',marginBottom:'1rem',paddingBottom:'0.5rem',borderBottom:'2px solid rgba(255,255,255,0.2)'}><span style={fontSize:'1.5rem'}>💧</span><h3 style={margin:0,fontSize:'1.1rem',fontWeight:'600',color:'rgba(255,255,255,0.95)'}>Sjögren</h3></div><div style={{display:'flex',gap:'1rem',flexWrap:'wrap',justifyContent:'center'}}><div className="feature"><span className="feature-icon">💧</span><span>ESSPRI</span></div><div className="feature"><span className="feature-icon">🔬</span><span>SSDAI</span></div></div></div><div style={width:'100%',marginTop:'2rem',marginBottom:'1.5rem'}><div style={display:'flex',alignItems:'center',gap:'0.75rem',marginBottom:'1rem',paddingBottom:'0.5rem',borderBottom:'2px solid rgba(255,255,255,0.2)'}><span style={fontSize:'1.5rem'}>❤️</span><h3 style={margin:0,fontSize:'1.1rem',fontWeight:'600',color:'rgba(255,255,255,0.95)'}>Riesgo CV</h3></div><div style={{display:'flex',gap:'1rem',flexWrap:'wrap',justifyContent:'center'}}><div className="feature"><span className="feature-icon">💗</span><span>SCORE2</span></div><div className="feature"><span className="feature-icon">❤️</span><span>SCORE2-OP</span></div><div className="feature"><span className="feature-icon">🫀</span><span>QRISK3</span></div></div></div></div>
...
<div style={{fontWeight:'700',fontSize:'1.1rem',color:'#1e293b'}}>Espondilo</div>
...
<span style={{fontSize:'1.5rem'}}>🔴</span>
<div style={{textAlign:'left'}}>
<div style={{fontWeight:'700',fontSize:'1.1rem',color:'#1e293b'}}>APs</div>
...
<span style={{fontSize:'1.5rem'}}>🔵</span>
<div style={{textAlign:'left'}}>
<div style={{fontWeight:'700',fontSize:'1.1rem',color:'#1e293b'}}>AR</div>
...
<span style={{fontSize:'1.5rem'}}>🦋</span>
<div style={{textAlign:'left'}}>
<div style={{fontWeight:'700',fontSize:'1.1rem',color:'#1e293b'}}>Lupus</div>
<div style={{fontSize:'0.85rem',color:'#64748b',marginTop:'0.25rem'}}>2 calcs</div>
</div>
</div>
...
<span style={{fontSize:'1.5rem'}}>💚</span>
<div style={{textAlign:'left'}}>
<div style={{fontWeight:'700',fontSize:'1.1rem',color:'#1e293b'}}>CV</div>
...
<span className="calc-desc">Sínt.</span>
</button>
...
<div style={{textAlign:'left'}}>
<div style={{fontWeight:'700',fontSize:'1.1rem',color:'#1e293b'}}>Riesgo CV</div>
<div style={{fontSize:'0.85rem',color:'#64748b',marginTop:'0.25rem'}}>3 calcs</div>
</div>
</div>
