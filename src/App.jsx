...
const LandingPage = ({ onNavigate }) => (
  <div className="landing-page">
    ...
    <footer className="landing-footer">
      <Brand size="small" />
      <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', fontSize: '13px', marginBottom: '8px' }}>
      ...
      <p>© 2026 ReumaCal - Herramienta clínica</p>
    </footer>
  </div>
);

const SCORE2Calculator = ({ onResult }) => {
  const [components, setComponents] = useState({
    age: 55,
    sex: 'male',
    smoking: 'no',
  ...
  const handleCalculate = () => {
    const score = calculateSCORE2(components);
  ...
  return (
    <div className="calculator-form">
      ...
      <div className="form-group">
        <label>Región de riesgo cardiovascular</label>
        <select
      ...
      <div style={{ 
        ...
        <p style={{ margin: 0, color: '#6b7280' }}>
          <strong>Nota:</strong> Para convertir colesterol de mg/dL a mmol/L, divide entre 38.67
          <br/>Ejemplo: 200 mg/dL ÷ 38.67 = 5.2 mmol/L
        </p>
      </div>
...
const SCORE2OPCalculator = ({ onResult }) => {
  const [components, setComponents] = useState({
    age: 75,
    sex: 'male',
    smoking: 'no',
  ...
  const handleCalculate = () => {
    const score = calculateSCORE2OP(components);
      ...
      {!selectedCalc ? (
        ...
        <>
          ...
          <div className="calc-container">
            ...
            {selectedCalc === 'SCORE2' && <SCORE2Calculator onResult={handleResult} />}
            {selectedCalc === 'SCORE2-OP' && <SCORE2OPCalculator onResult={handleResult} />}
...
const PoliticaPrivacidadPage = ({ onBack }) => (
  <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'system-ui, sans-serif', color: '#333', lineHeight: '1.7' }}>
    ...
    <p>Para ejercer estos derechos, contacta con tu reumatólogo o directamente en: <strong>[tu-email@ejemplo.com]</strong></p>
    ...
    <p>Al registrarte consientes expresamente el tratamiento de tus datos de salud. Puedes retirar tu consentimiento en cualquier momento en <strong>[tu-email@ejemplo.com]</strong>, sin que ello afecte a la licitud del tratamiento previo.</p>
