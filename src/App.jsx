...
const ASDASCalculator = ({ onResult, isDoctor = false }) => {
...
const DAPSACalculator = ({ onResult, isDoctor = false }) => {
  const [components, setComponents] = useState({
...
const DAS28Calculator = ({ onResult, isDoctor = false }) => {
  const [variant, setVariant] = useState('CRP');
  const [components, setComponents] = useState({
...
const SCORE2Calculator = ({ onResult, isDoctor = false }) => {
  const [components, setComponents] = useState({
    age: 55,
    sex: 'male',
    smoking: 'no',
...
const SCORE2OPCalculator = ({ onResult, isDoctor = false }) => {
  const [components, setComponents] = useState({
    age: 75,
    sex: 'male',
    smoking: 'no',
