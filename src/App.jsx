...
const COLLABORATIVE_CALCULATORS = {
  ...
  'ESSDAI': {
    ...
    patientLabel: 'ESSDAI',
    patientDesc: 'Esta calculadora la completará el reumatólogo/a en consulta',
    doctorLabel: 'ESSDAI - Actividad de la enfermedad'
  }
};
...
const ESSDAICalculator = ({ onResult, isDoctor = false }) => {
  ...
  return (
    <div className="calculator-form">
      ...
      <p className="calc-description" style={{ marginTop: '0.25rem', fontSize: '0.9rem', color: '#64748b' }}>
        Actividad de la enfermedad en síndrome de Sjögren (puntuación 0-123)
      </p>
        ...
        {loading ? (
          ...
          <div className="summary-grid">
            {Object.entries(lastScores).map(([inst, score]) => {
              ...
              else if (inst === 'ESSDAI') interpretation = interpretESSDAI(score.total_score);
          ...
          <table>
            ...
            <tbody>
              {filteredScores.map((score) => {
                ...
                else if (score.instrument === 'ESSDAI') interpretation = interpretESSDAI(score.total_score);
