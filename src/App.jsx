...
const ASDASCalculator = ({ onResult }) => {
  ...
  return (
    <div className="calculator-form">
      ...
      {variant === 'CRP' ? (
        <FormInput
          label="PCR (solo puede completarlo el reumatólogo/a)"
          type="number"
        ...
        <FormInput
          label="VSG (solo puede completarlo el reumatólogo/a)"
          type="number"
...
const DAPSACalculator = ({ onResult }) => {
  ...
  return (
    <div className="calculator-form">
      ...
      />
      <FormInput
        label="Articulaciones dolorosas - TJC (solo puede completarlo el reumatólogo/a)"
        type="number"
      ...
      />
      <FormInput
        label="Articulaciones tumefactas - SJC (solo puede completarlo el reumatólogo/a)"
        type="number"
...
const DAS28Calculator = ({ onResult }) => {
  ...
  return (
    <div className="calculator-form">
      ...
      <FormInput
        label="Articulaciones dolorosas - TJC28 (solo puede completarlo el reumatólogo/a)"
        type="number"
      ...
      />
      <FormInput
        label="Articulaciones tumefactas - SJC28 (solo puede completarlo el reumatólogo/a)"
        type="number"
...
const SCORE2Calculator = ({ onResult }) => {
  ...
  return (
    <div className="calculator-form">
      ...
      <FormInput
        label="Presión Arterial Sistólica - PA (solo puede completarlo el reumatólogo/a)"
        type="number"
      ...
      <FormInput
        label="Colesterol Total (solo puede completarlo el reumatólogo/a)"
        type="number"
      ...
      <div className="form-group">
        <label>Región de riesgo cardiovascular (solo puede completarlo el reumatólogo/a)</label>
        <select
